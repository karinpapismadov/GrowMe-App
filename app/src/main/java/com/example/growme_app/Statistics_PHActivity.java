...
public class Statistics_PHActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistics_phactivity);
        ...
        statisticsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                DataSnapshot waterLevelSnapshot = dataSnapshot.child("PH value").child("Average");
        ...
        graph.setOnClickListener(view -> {
            Intent intent = new Intent(Statistics_PHActivity.this, Statistics_PHActivity_Grpah.class);
            startActivity(intent);
        });

        //back button
        back.setOnClickListener(view -> {
            Intent intent = new Intent(Statistics_PHActivity.this, StatisticsActivity.class);
            startActivity(intent);
        });
    }
}