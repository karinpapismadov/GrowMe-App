...
public class Statistics_tempActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistics_temp);
        ...
        statisticsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                DataSnapshot waterLevelSnapshot = dataSnapshot.child("Temperature").child("Average");
        ...
        graph.setOnClickListener(view -> {
            Intent intent = new Intent(Statistics_tempActivity.this, Statistics_tempActivity_graph.class);
            startActivity(intent);
        });

        //back button
        back.setOnClickListener(view -> {
            Intent intent = new Intent(Statistics_tempActivity.this, StatisticsActivity.class);
            startActivity(intent);
        });
    }
}